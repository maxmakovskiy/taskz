...
public:
    ...
    // compute index in vector as hasher(value) % buckets.size()
    // where buckets.size() is assign in ctor
    bool Has(const Type& value) const
    {
        const auto& list = buckets[hasher(value) % buckets.size()];
    ...
    void Erase(const Type& value)
    {
        ...
        buckets[hasher(value) % buckets.size()].remove(value);
    }
